...
if (pageType === "Reg") {
  ...
  if (document.querySelector('input[name="agree"][type="checkbox"]')) {
    ...
    $(".input-wrap.tos").append(
      '<div class="fancy-input checkbox"><i class="fa-solid fa-check"></i></div> <p>I agree to the terms of this registration, <b>I am at least 18 years of age,</b> and wish to proceed.</p>',
    );
  }
}
...
if (pageType === "ST") {
  ...
  document.querySelectorAll("#qr_open .input-wrap").forEach((label) => {
    label
      ...
      .insertAdjacentHTML(
        "afterend",
        `<div class="fancy-input checkbox">x</div>`,
      );
  });
